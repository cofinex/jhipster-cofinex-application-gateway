...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("io.cofinex.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("io.cofinex.security.DomainUserDetailsService", "createSpringSecurityUser");
